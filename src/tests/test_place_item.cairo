...
mod tests {
    ...
    fn test_place_item() {
        ...
        assert(item.count == 47, 'total item count mismatch');
        ...
        let mut backpack_grid_data = get!(world, (alice, 4, 5), BackpackGrids);
        assert(backpack_grid_data.occupied == true, '(4,5) should be occupied');
        ...
        assert(invetoryItem.itemId == 8, 'item id should equal 8');
    ...
    fn test_place_item_revert_y_out_of_range() {
        ...
        actions_system.buy_item(4);
        // place a sword on (2,7)
        actions_system.place_item(2, 2, 7, 0);
    }
    ...
    fn test_place_item_revert_x_OOB() {
        ...
        actions_system.buy_item(4);
        // place a sword on (6,6) with rotation 90
        actions_system.place_item(2, 6, 6, 90);
    }
    #[test]
    #[available_gas(3000000000000000)]
    ...
    fn test_place_item_revert_y_OOB() {
        ...
        actions_system.buy_item(4);
        // place a sword on (0,7)
        actions_system.place_item(2, 0, 6, 0);
    }
    ...
    fn test_place_item_with_rotation() {
        ...
        let mut backpack_grid_data = get!(world, (alice, 3, 4), BackpackGrids);
        assert(backpack_grid_data.occupied == true, '(4,3) should be occupied');
