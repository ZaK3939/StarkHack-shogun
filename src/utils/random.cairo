...
fn pseudo_seed() -> (u128, u128, u128, u128, u128) {
    ...
    let blockTimestamp2: u128 = (blockTimestamp + 1).into();
    let blockNumber2: u128 = (blockNumber + 1).into();

    (tx.low, blockTimestamp, blockNumber, blockTimestamp2, blockNumber2)
}
