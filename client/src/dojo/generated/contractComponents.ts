    ...
    return {
        ...
        BattleLog: (() => {
            return defineComponent(
                world,
                {
                    player: RecsType.BigInt,
                    id: RecsType.Number,
                    dummyCharLevel: RecsType.Number,
                    dummyCharId: RecsType.Number,
        ...
        BattleLogDetail: (() => {
            return defineComponent(
                ...
                {
                    player: RecsType.BigInt,
                    battleLogId: RecsType.Number,
                    id: RecsType.Number,
                    whoTriggered: RecsType.BigInt,
                    whichItem: RecsType.Number,
                    damageCaused: RecsType.Number,
                    isDodged: RecsType.Boolean,
                    cleansespike: RecsType.Number,
                    buffType: RecsType.BigInt,
                    regenHP: RecsType.Number,
                    player_armor_stacks: RecsType.Number,
                    player_regen_stacks: RecsType.Number,
                    player_reflect_stacks: RecsType.Number,
                    player_spike_stacks: RecsType.Number,
                    dummy_armor_stacks: RecsType.Number,
                    dummy_regen_stacks: RecsType.Number,
                    dummy_reflect_stacks: RecsType.Number,
                    dummy_spike_stacks: RecsType.Number,
                },
                {
                    metadata: {
        ...
        Character: (() => {
            return defineComponent(
                world,
                {
                    ...
                    loss: RecsType.Number,
                    dummied: RecsType.Boolean,
                    rating: RecsType.Number,
                    totalWins: RecsType.Number,
                    totalLoss: RecsType.Number,
                    winStreak: RecsType.Number,
                    birthCount: RecsType.Number,
                    updatedAt: RecsType.BigInt,
                },
                {
                    metadata: {
                        name: "Character",
        ...
        Item: (() => {
            return defineComponent(
                world,
                {
                    ...
                    cleansespike: RecsType.Number,
                    chance: RecsType.Number,
                    coolTime: RecsType.Number,
                    rarity: RecsType.Number,
                    armor: RecsType.Number,
                    armorType: RecsType.Number,
                    regen: RecsType.Number,
                    regenType: RecsType.Number,
                    reflect: RecsType.Number,
                    reflectType: RecsType.Number,
                    spike: RecsType.Number,
                    spikeType: RecsType.Number,
                },
                {
                    metadata: {
                        name: "Item",
        ...
        Shop: (() => {
            return defineComponent(
                world,
                {
                    ...
                    item2: RecsType.Number,
                    item3: RecsType.Number,
                    item4: RecsType.Number,
                    item5: RecsType.Number,
                    item6: RecsType.Number,
                },
                {
                    metadata: {
                        name: "Shop",
